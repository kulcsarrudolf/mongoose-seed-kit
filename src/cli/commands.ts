...
export function printUsage(): void {
  ...
  console.log('  mongoose-seed-kit run [name]      Run pending seeders or one seeder');
  console.log('  mongoose-seed-kit reset <name>    Mark a seeder as pending');
  console.log('');
  console.log('MongoDB URI: set MONGODB_URI or DATABASE_URL, or configure mongoUri.');
}

function getMongoUri(config: Partial<MongooseSeederConfig>, env: CliEnv): string {
